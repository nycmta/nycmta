...
## Merge Weather & Create Heatwave / Storm
...
if (isTRUE(params$write_outputs)) {
  ...
  readr::write_csv(panel_station_day_filt, file.path(out_dir, "panel_station_day.csv"))
  readr::write_csv(panel_station_hour,     file.path(out_dir, "panel_station_hour.csv"))
...
df <- read_parquet("data/derived/panel_station_day_indexed.parquet")
