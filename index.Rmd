...
* *MTA Subway Hourly Ridership: Manhattan stations, 2024-2025*
  ...
  - **Complete data (Manhattan only):**
    - 2024: [`data/mta_ridership_full/ridership_2024_manhattan.csv`](data/mta_ridership_full/ridership_2024_manhattan.csv) (1,068,507 records, 64.6 MB)
    - 2025: [`data/mta_ridership_full/ridership_2025_manhattan.csv`](data/mta_ridership_full/ridership_2025_manhattan.csv) (852,656 records, 51.6 MB)
    - Time span: January 2024 - October 2025 (22 months)
    - Coverage: 123 Manhattan stations, 1.92M hourly observations
  - Sample data: [`data/mta_ridership/mta_hourly_2020_2024_sample.csv`](data/mta_ridership/mta_hourly_2020_2024_sample.csv), [`data/mta_ridership/mta_hourly_2025_sample.csv`](data/mta_ridership/mta_hourly_2025_sample.csv)
...
* *NOAA GHCN-Daily — Central Park Station* (station ID: USW00094728): daily maximum temperature, precipitation, and snowfall
  ...
  - Downloaded data (2020-2025):
    - [`data/weather/central_park_weather_wide.csv`](data/weather/central_park_weather_wide.csv) (one row per date, 1,976 days)
    - [`data/weather/central_park_weather_long.csv`](data/weather/central_park_weather_long.csv) (long format)
...
* *NYC Permitted Event Information* — historical and current permits (parades, street fairs, etc.)
  ...
  - Downloaded data (2020-present, 10,000 events): [`data/events/nyc_permitted_events.csv`](data/events/nyc_permitted_events.csv)
